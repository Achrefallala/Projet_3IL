...
interface Player {
  name: string;
  // Add other properties of the player as needed
}
...
function EditPlayer(props) {
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(`http://localhost:3001/player/update/${player.id}`, formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        });
        // addPlayerToSubtitutes(response.data.player)
                  ...
                  <Box sx={{ minWidth: 120 }}>
                    <FormControl fullWidth>
                      ...
                      >
                        ...
                        <MenuItem value={"dmf"}>DMF</MenuItem>
