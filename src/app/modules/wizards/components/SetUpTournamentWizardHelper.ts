...
const SetUpTournamentschemas = [
    ...
    Yup.object({
        ...
        NumberTeams: Yup.number().min(4, 'Minimum 4 teams are required').test('is-multiple-of-eight-or-4', 'The number of teams must be a multiple of 4 or exactly 2', value => value === 4 || (value ? value % 8 === 0 : false)).required('Number of Teams is required'), 
